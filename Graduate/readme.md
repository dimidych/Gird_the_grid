...
### Сценарии масштабируемости 
	...
	- Использование балансировщиков и контейнеров - позволяет быстро вводить в строй новые сервисные ноды для равномерного распределения нагрузки.
...
### Обеспечение отказоустойчивости 
	...
	- Алертинг - система оповещает о событиях безопасности и сбоях (встроенные в сервисы хелзчеки).
